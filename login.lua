...
--DisabledStall(1); -- c蕀 ng錳 b竛
	...
	if HaveCommonItem(6,1,1266) <1 then
		tbAwardTemplet:GiveAwardByList({{szName="Ph?,tbProp={6,1,1266,1,0},nCount=1,},}, "npctest", 1);
	end	
	if HaveCommonItem(6,1,438)<1 then
		tbAwardTemplet:GiveAwardByList({{szName="Ph?,tbProp={6,1,438,1,0},nCount=1,},}, "npctest", 1);
	end
	if HaveCommonItem(6,1,15002)<1 then
	tbAwardTemplet:GiveAwardByList({{szName="",tbProp={6,1,15002,1,0},nCount=1,},}, "npctest", 1); 
	end
